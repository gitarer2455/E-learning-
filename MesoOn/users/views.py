...
def kerkesa(request):
    if request.method == 'POST':
        ...
        message = 'Your request for a mentor account has been accepted! Now you can return to MesoOn and upload courses and lectures, work done!'
        send_mail(
        ...
        send_mail(
            'Aka',
            'Someone made a request for the mentors account. Me info: ' + emri + ' , ' + email + ' , ' + numri_tel + ' , ' + str(prof) + '.',
            'mesoon@no-reply.com',
